...
public class CyclingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle osavedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance()
                .getReference("history").child(userId).child("cycling");
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Play sound effect
                MediaPlayer mediaPlayer = MediaPlayer.create(CyclingActivity.this, R.raw.start);
                mediaPlayer.start();
                try {
                    Thread.sleep(4000);
                    startTracking();
        ...
        pauseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Play sound effect
                MediaPlayer mediaPlayer = MediaPlayer.create(CyclingActivity.this, R.raw.clicked);
                mediaPlayer.start();
                pauseTracking();
            }
        });
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Play sound effect
                MediaPlayer mediaPlayer = MediaPlayer.create(CyclingActivity.this, R.raw.stop);
                mediaPlayer.start();
                stopTracking();
            }
        });
        ...
        public void onLocationResult(LocationResult locationResult) {
            if (isTracking && locationResult != null) {
                for (Location location : locationResult.getLocations()) {
                    ...
                    WeatherAlertPopup.checkAndShowWeatherAlert(CyclingActivity.this, location.getLatitude(), location.getLongitude());
                }
            }
        }
    };
