...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void forecastCal(TextView forecast, TextView forecastTemp, ImageView forecastIcons, int index,
        ...
        // Define the next forecast times (3-hour intervals: 3, 6, 9, 12, 15 hours from
        // now)
